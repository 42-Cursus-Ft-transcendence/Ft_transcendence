...
const userRoutes_1 = __importStar(require("./routes/userRoutes")); // ← import par défaut
            ...
            switch (msg.type) {
                ...
                case "stop": {
                    ...
                    if (sess) {
                        ...
                        const row1 = await (0, userRoutes_1.getAsync)(`SELECT address FROM User WHERE idUser = ?`, [sess.players.p1.sub]);
                        const row2 = await (0, userRoutes_1.getAsync)(`SELECT address FROM User WHERE idUser = ?`, [sess.players.p2.sub]);
                        if (!row1 || !row2) {
